...
namespace BLL.Interface
{
	public interface IPacketSimilarityService
	{
		...
		Task<PacketSimilarityThresholdResponse> GetThresholdRecommendationAsync(long examId, SimilarityScope scope, int userId, int? questionNumber);
		Task<PacketSimilaritySeedResponse> SeedTestDataAsync(long examId, int userId, int studentCount, int questionCount);
	}
}
